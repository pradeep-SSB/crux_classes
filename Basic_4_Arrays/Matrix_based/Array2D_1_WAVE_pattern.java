...
public class Array2D_1_WAVE_pattern
{
    ...
    public static int[][] take_input() {
        ...
        final int rows = Array2D_1_WAVE_pattern.in.nextInt();
        final int[][] arr = new int[rows][];
        for (int row = 0; row < arr.length; ++row) {
            System.out.println("Col size: ");
            final int cols = Array2D_1_WAVE_pattern.in.nextInt();
            arr[row] = new int[cols];
            for (int col = 0; col < cols; ++col) {
                arr[row][col] = Array2D_1_WAVE_pattern.in.nextInt();
            }
        }
        return arr;
    }
